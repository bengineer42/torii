...
use torii_db_types::{AggregatorConfig, Hook, ModelIndices};
...
pub use torii_db_types as types;
    ...
    pub async fn new_with_config(
        ...
        for contract in contracts {
            executor.send(QueryMessage::other(
                "INSERT INTO contracts (id, contract_address, contract_type, updated_at) VALUES ($1, \
                 $2, $3, CURRENT_TIMESTAMP) ON CONFLICT (id) DO NOTHING"
                    .to_string(),
                vec![
